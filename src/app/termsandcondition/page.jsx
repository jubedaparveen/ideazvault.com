...
const TermsAndConditionPage = () => {
  return (
    <div className=" py-20">
    <div className="max-w-7xl py-20 mx-auto bg-[#96ae95]/20  shadow-[1px_1px_10px_5px_rgba(0,0,0,0.25)] rounded-lg p-6">
      <h1 className="text-3xl font-bold">Terms and Conditions</h1>
      <p className="text-gray-500">Last updated: Jan 2025</p>
      <p className="mt-2">Welcome to our website! By accessing or using our services, you agree to comply with the following terms and conditions:</p>
      ...
      <p>All content on this website, including text, graphics, logos, and images, is the property of our company and is protected by copyright and trademark laws.</p>
      <h2 className="text-xl font-semibold mt-4">4. Limitation of Liability</h2>
      <p>In no event shall our company be liable for any indirect, incidental, or consequential damages arising from your use of our services.</p>
      ...
      <p>If you have any questions or concerns about these terms, please contact us at:vedshree.in </p>
